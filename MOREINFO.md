...
[New control flow block syntax in the template](https://youtu.be/j9VTGRGyE-o)

[To code along and build a signals-based application from scratch](https://youtu.be/LHgJP7MwTWY)

[Angular guidance on signal effect](https://angular.dev/guide/signals#effects)

[Alternatives to using a signal effect](https://youtu.be/XWz8pxQWD8c)
